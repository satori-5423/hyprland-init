...
sudo cp "$SCRIPT_DIR/mirrors/cachyos-mirrorlist" /etc/pacman.d/cachyos-mirrorlist
sudo cp "$SCRIPT_DIR/mirrors/cachyos-v3-mirrorlist" /etc/pacman.d/cachyos-v3-mirrorlist
sudo cp "$SCRIPT_DIR/mirrors/cachyos-v4-mirrorlist" /etc/pacman.d/cachyos-v4-mirrorlist
